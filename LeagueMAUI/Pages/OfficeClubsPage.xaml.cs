...
public partial class OfficeClubsPage : ContentPage
{
    private readonly ApiService _apiService;
    private readonly IValidator _validator;
    private bool _isDataLoaded = false;
    private bool _loginPageDisplayed = false;
    public OfficeClubsPage(ApiService apiService, IValidator validator)
    {
        InitializeComponent();
    ...
    private void CvClubs_SelectionChanged(object sender, SelectionChangedEventArgs e)
    {
        ...
        Navigation.PushAsync(new OfficePlayersPage(_apiService, _validator, currentSelection));
